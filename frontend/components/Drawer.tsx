...
const styles = StyleSheet.create({
  ...
  userInfo: { flex: 1 },
  userName: { fontSize: 17, fontWeight: '700', color: '#313852', marginBottom: 2 },
  userEmail: { fontSize: 13, color: '#2F2F2F' },
  divider: { height: 1, backgroundColor: '#C3CAD4', marginHorizontal: 20, marginBottom: 10 },
  navList: { flex: 1, paddingHorizontal: 12, paddingTop: 6 },
  navItem: {
    paddingVertical: 13, paddingHorizontal: 16,
    borderRadius: 12, marginBottom: 2,
  },
  navItemActive: { backgroundColor: '#313852' },
  navLabel: { fontSize: 17, color: '#2F2F2F', fontWeight: '500' },
  navLabelActive: { color: '#fff', fontWeight: '600' },
  signOut: {
    paddingHorizontal: 28, paddingVertical: 18,
    borderTopWidth: 1, borderTopColor: '#C3CAD4',
  },
  signOutText: { fontSize: 16, color: '#ff0000', fontWeight: '600' },
});
