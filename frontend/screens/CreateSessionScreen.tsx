...
export default function CreateSessionScreen({ nav }: { nav: NavProps }) {
  ...
  // Pre-fill from user preferences set in Settings
      ...
      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.toggleCard} padding={spacing.lg}>
          <View style={styles.toggleInfo}>
            ...
            <Text style={styles.toggleSub}>25 min focus · 5 min break</Text>
          </View>
          <Switch value={pomodoro} onValueChange={setPomodoro} trackColor={{ true: colors.ink }} thumbColor={colors.white} />
        </Card>

        {/* Recurring */}
        <Card style={[styles.toggleCard, { marginTop: spacing.sm }]} padding={spacing.lg}>
          <View style={styles.toggleInfo}>
            <Text style={styles.toggleTitle}>Daily Recurring</Text>
            <Text style={styles.toggleSub}>Repeat this session every day</Text>
          </View>
          <Switch value={recurring} onValueChange={setRecurring} trackColor={{ true: colors.ink }} thumbColor={colors.white} />
        </Card>
