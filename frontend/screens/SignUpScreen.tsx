...
// Registration screen. Calls POST /auth/register, sets the global token on success.
...
const styles = StyleSheet.create({
  ...
  button:         { backgroundColor: '#313852', borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 16, marginBottom: 24 },
